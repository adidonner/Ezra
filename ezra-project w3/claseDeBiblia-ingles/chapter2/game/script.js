...
const initialImages = [
    { word: "different", src: "different.jpg" },
    { word: "cold", src: "cold.png" },
    { word: "warm", src: "warm.png" },
    { word: "pleasent", src: "pleasent.png" },
    { word: "live", src: "live.jpeg" },
    { word: "happy", src: "happy.png" }
];
