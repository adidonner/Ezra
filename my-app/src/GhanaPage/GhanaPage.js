...
import './GhanaPage.css'; // ייבוא קובץ ה-CSS
...
function Flag() {
  return (
    <div className="flag-container">
      <img src="https://flagcdn.com/gh.svg" alt="Bandera de Ghana" className="country-flag" />
    </div>
  );
}
    ...
    <div className="video-wrapper">
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <iframe
          width="640"
          height="360"
          src="https://www.youtube.com/embed/eO17oGRqY4I"
          title="[Prayer24·365] Pray for Ghana- Prayercast"
          frameBorder="0"
      ...
      <div className="video-link">
        <a href="https://prayercast.com/prayer-topic/ghana/" target="_blank">
          Ir al sitio web
        </a>
      </div>
      <br />
...
function ImportantInformation() {
  return (
    <div className="right-sidebar">
      ...
      <a href="https://joshuaproject.net/countries/GH" className="link-button" target="_blank">
        Pueblos,
        <br />
        Estados,
        <br />
